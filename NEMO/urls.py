...
urlpatterns = [
	...
	url(r'^choose_core/$', authentication.choose_core, name='choose_core'),
	...
	url(r'^enable_tool/(?P<tool_id>\d+)/user/(?P<user_id>\d+)/project/(?P<project_id>\d+)/staff_charge/(?P<staff_charge>(true|false))/billing_mode/(?P<billing_mode>(true|false))/$', tool_control.enable_tool, name='enable_tool'),
	url(r'^enable_tool_multi/$', tool_control.enable_tool_multi, name='enable_tool_multi'),
	...
	url(r'^email_broadcast/(?P<audience>tool|account|project|user|group|tool_date|project_date|active_users|active_users_date)/$', email.email_broadcast, name='email_broadcast'),
