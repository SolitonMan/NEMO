	...
	# If a reservation is requested and configuration information is present also...
		...
		if b_send_mail:
			...
			if b_conf_update:
				...
				msg = 'The reservation for the ' + str(tool.name) + ' for ' + new_reservation.customers[0] + ' on ' + str(new_reservation.start) + ' has been updated with new configuration settings.'
