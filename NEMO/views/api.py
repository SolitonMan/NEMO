...
from NEMO.serializers import UserSerializer, UserFullSerializer, ProjectSerializer, AccountSerializer, ReservationSerializer, UsageEventSerializer, AreaAccessRecordSerializer, TaskSerializer, ScheduledOutageSerializer, ToolSerializer
...
class UserFullViewSet(ReadOnlyModelViewSet):
	queryset = User.objects.all()
